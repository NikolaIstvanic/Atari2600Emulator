 ...
 *                   $$$$$Y'          $$$$$          `Y$$$$$
 *
 * CPU.cpp: class which programmatically recreates the Atari 2600's MOS 6502 CPU
 */
#include <iostream>
#include <memory>
...
CPU::CPU() {
    instruction_rom = {{
        ...
        {"JSR", &CPU::JSR, &CPU::ABS, 6}, {"AND", &CPU::AND, &CPU::IDX, 6}, {"KIL", &CPU::KIL, &CPU::IMP, 2}, {"RLA", &CPU::RLA, &CPU::IDX, 8}, {"BIT", &CPU::BIT, &CPU::ZRP, 3}, {"AND", &CPU::AND, &CPU::ZRP, 3}, {"ROL", &CPU::ROL, &CPU::ZRP, 5}, {"RLA", &CPU::RLA, &CPU::ZRP, 5}, {"PLP", &CPU::PLP, &CPU::IMP, 4}, {"AND", &CPU::AND, &CPU::IMM, 2}, {"ROL", &CPU::ROL, &CPU::ACC, 2}, {"ANC", &CPU::ANC, &CPU::IMM, 2}, {"BIT", &CPU::BIT, &CPU::ABS, 4}, {"AND", &CPU::AND, &CPU::ABS, 4}, {"ROL", &CPU::ROL, &CPU::ABS, 6}, {"RLA", &CPU::RLA, &CPU::ABS, 6},
        ...
        {"RTI", &CPU::RTI, &CPU::IMP, 6}, {"EOR", &CPU::EOR, &CPU::IDX, 6}, {"KIL", &CPU::KIL, &CPU::IMP, 2}, {"SRE", &CPU::SRE, &CPU::IDX, 8}, {"DOP", &CPU::DOP, &CPU::ZRP, 3}, {"EOR", &CPU::EOR, &CPU::ZRP, 3}, {"LSR", &CPU::LSR, &CPU::ZRP, 5}, {"SRE", &CPU::SRE, &CPU::ZRP, 5}, {"PHA", &CPU::PHA, &CPU::IMP, 3}, {"EOR", &CPU::EOR, &CPU::IMM, 2}, {"LSR", &CPU::LSR, &CPU::ACC, 2}, {"ASR", &CPU::ASR, &CPU::IMM, 2}, {"JMP", &CPU::JMP, &CPU::ABS, 3}, {"EOR", &CPU::EOR, &CPU::ABS, 4}, {"LSR", &CPU::LSR, &CPU::ABS, 6}, {"SRE", &CPU::SRE, &CPU::ABS, 6},
        {"BVC", &CPU::BVC, &CPU::REL, 2}, {"EOR", &CPU::EOR, &CPU::IDY, 5}, {"KIL", &CPU::KIL, &CPU::IMP, 2}, {"SRE", &CPU::SRE, &CPU::IDY, 8}, {"DOP", &CPU::DOP, &CPU::ZPX, 4}, {"EOR", &CPU::EOR, &CPU::ZPX, 4}, {"LSR", &CPU::LSR, &CPU::ZPX, 6}, {"SRE", &CPU::SRE, &CPU::ZPX, 6}, {"CLI", &CPU::CLI, &CPU::IMP, 2}, {"EOR", &CPU::EOR, &CPU::ABY, 4}, {"NOP", &CPU::NOP, &CPU::IMP, 2}, {"SRE", &CPU::SRE, &CPU::ABY, 7}, {"TOP", &CPU::TOP, &CPU::ABX, 4}, {"EOR", &CPU::EOR, &CPU::ABX, 4}, {"LSR", &CPU::LSR, &CPU::ABX, 7}, {"SRE", &CPU::SRE, &CPU::ABX, 7},
        {"RTS", &CPU::RTS, &CPU::IMP, 6}, {"ADC", &CPU::ADC, &CPU::IDX, 6}, {"KIL", &CPU::KIL, &CPU::IMP, 2}, {"RRA", &CPU::RRA, &CPU::IDX, 8}, {"DOP", &CPU::DOP, &CPU::ZRP, 3}, {"ADC", &CPU::ADC, &CPU::ZRP, 3}, {"ROR", &CPU::ROR, &CPU::ZRP, 5}, {"RRA", &CPU::RRA, &CPU::ZRP, 5}, {"PLA", &CPU::PLA, &CPU::IMP, 4}, {"ADC", &CPU::ADC, &CPU::IMM, 2}, {"ROR", &CPU::ROR, &CPU::ACC, 2}, {"ARR", &CPU::ARR, &CPU::IMM, 2}, {"JMP", &CPU::JMP, &CPU::IND, 5}, {"ADC", &CPU::ADC, &CPU::ABS, 4}, {"ROR", &CPU::ROR, &CPU::ABS, 6}, {"RRA", &CPU::RRA, &CPU::ABS, 6},
        {"BVS", &CPU::BVS, &CPU::REL, 2}, {"ADC", &CPU::ADC, &CPU::IDY, 5}, {"KIL", &CPU::KIL, &CPU::IMP, 2}, {"RRA", &CPU::RRA, &CPU::IDY, 8}, {"DOP", &CPU::DOP, &CPU::ZPX, 4}, {"ADC", &CPU::ADC, &CPU::ZPX, 4}, {"ROR", &CPU::ROR, &CPU::ZPX, 6}, {"RRA", &CPU::RRA, &CPU::ZPX, 6}, {"SEI", &CPU::SEI, &CPU::IMP, 2}, {"ADC", &CPU::ADC, &CPU::ABY, 4}, {"NOP", &CPU::NOP, &CPU::IMP, 2}, {"RRA", &CPU::RRA, &CPU::ABY, 7}, {"TOP", &CPU::TOP, &CPU::ABX, 4}, {"ADC", &CPU::ADC, &CPU::ABX, 4}, {"ROR", &CPU::ROR, &CPU::ABX, 7}, {"RRA", &CPU::RRA, &CPU::ABX, 7},
        {"DOP", &CPU::DOP, &CPU::IMM, 2}, {"STA", &CPU::STA, &CPU::IDX, 6}, {"DOP", &CPU::DOP, &CPU::IMM, 2}, {"SAX", &CPU::SAX, &CPU::IDX, 6}, {"STY", &CPU::STY, &CPU::ZRP, 3}, {"STA", &CPU::STA, &CPU::ZRP, 3}, {"STX", &CPU::STX, &CPU::ZRP, 3}, {"SAX", &CPU::SAX, &CPU::ZRP, 3}, {"DEY", &CPU::DEY, &CPU::IMP, 2}, {"DOP", &CPU::DOP, &CPU::IMM, 2}, {"TXA", &CPU::TXA, &CPU::IMP, 2}, {"ANE", &CPU::ANE, &CPU::IMM, 2}, {"STY", &CPU::STY, &CPU::ABS, 4}, {"STA", &CPU::STA, &CPU::ABS, 4}, {"STX", &CPU::STX, &CPU::ABS, 4}, {"SAX", &CPU::SAX, &CPU::ABS, 4},
        ...
        {"LDY", &CPU::LDY, &CPU::IMM, 2}, {"LDA", &CPU::LDA, &CPU::IDX, 6}, {"LDX", &CPU::LDX, &CPU::IMM, 2}, {"LAX", &CPU::LAX, &CPU::IDX, 6}, {"LDY", &CPU::LDY, &CPU::ZRP, 3}, {"LDA", &CPU::LDA, &CPU::ZRP, 3}, {"LDX", &CPU::LDX, &CPU::ZRP, 3}, {"LAX", &CPU::LAX, &CPU::ZRP, 3}, {"TAY", &CPU::TAY, &CPU::IMP, 2}, {"LDA", &CPU::LDA, &CPU::IMM, 2}, {"TAX", &CPU::TAX, &CPU::IMP, 2}, {"LXA", &CPU::LXA, &CPU::IMM, 2}, {"LDY", &CPU::LDY, &CPU::ABS, 4}, {"LDA", &CPU::LDA, &CPU::ABS, 4}, {"LDX", &CPU::LDX, &CPU::ABS, 4}, {"LAX", &CPU::LAX, &CPU::ABS, 4},
        {"BCS", &CPU::BCS, &CPU::REL, 2}, {"LDA", &CPU::LDA, &CPU::IDY, 5}, {"KIL", &CPU::KIL, &CPU::IMP, 2}, {"LAX", &CPU::LAX, &CPU::IDY, 5}, {"LDY", &CPU::LDY, &CPU::ZPX, 4}, {"LDA", &CPU::LDA, &CPU::ZPX, 4}, {"LDX", &CPU::LDX, &CPU::ZPY, 4}, {"LAX", &CPU::LAX, &CPU::ZPY, 4}, {"CLV", &CPU::CLV, &CPU::IMP, 2}, {"LDA", &CPU::LDA, &CPU::ABY, 4}, {"TSX", &CPU::TSX, &CPU::IMP, 2}, {"LAS", &CPU::LAS, &CPU::ABY, 4}, {"LDY", &CPU::LDY, &CPU::ABX, 4}, {"LDA", &CPU::LDA, &CPU::ABX, 4}, {"LDX", &CPU::LDX, &CPU::ABY, 4}, {"LAX", &CPU::LAX, &CPU::ABY, 4},
        {"CPY", &CPU::CPY, &CPU::IMM, 2}, {"CMP", &CPU::CMP, &CPU::IDX, 6}, {"DOP", &CPU::DOP, &CPU::IMM, 2}, {"DCP", &CPU::DCP, &CPU::IDX, 8}, {"CPY", &CPU::CPY, &CPU::ZRP, 3}, {"CMP", &CPU::CMP, &CPU::ZRP, 3}, {"DEC", &CPU::DEC, &CPU::ZRP, 5}, {"DCP", &CPU::DCP, &CPU::ZRP, 5}, {"INY", &CPU::INY, &CPU::IMP, 2}, {"CMP", &CPU::CMP, &CPU::IMM, 2}, {"DEX", &CPU::DEX, &CPU::IMP, 2}, {"SBX", &CPU::SBX, &CPU::IMP, 2}, {"CPY", &CPU::CPY, &CPU::ABS, 4}, {"CMP", &CPU::CMP, &CPU::ABS, 4}, {"DEC", &CPU::DEC, &CPU::ABS, 6}, {"DCP", &CPU::DCP, &CPU::ABS, 6},
        {"BNE", &CPU::BNE, &CPU::REL, 2}, {"CMP", &CPU::CMP, &CPU::IDY, 5}, {"KIL", &CPU::KIL, &CPU::IMP, 2}, {"DCP", &CPU::DCP, &CPU::IDY, 8}, {"DOP", &CPU::DOP, &CPU::ZPX, 4}, {"CMP", &CPU::CMP, &CPU::ZPX, 4}, {"DEC", &CPU::DEC, &CPU::ZPX, 6}, {"DCP", &CPU::DCP, &CPU::ZPX, 6}, {"CLD", &CPU::CLD, &CPU::IMP, 2}, {"CMP", &CPU::CMP, &CPU::ABY, 4}, {"NOP", &CPU::NOP, &CPU::IMP, 2}, {"DCP", &CPU::DCP, &CPU::ABY, 7}, {"TOP", &CPU::TOP, &CPU::ABX, 4}, {"CMP", &CPU::CMP, &CPU::ABX, 4}, {"DEC", &CPU::DEC, &CPU::ABX, 7}, {"DCP", &CPU::DCP, &CPU::ABX, 7},
        {"CPX", &CPU::CPX, &CPU::IMM, 2}, {"SBC", &CPU::SBC, &CPU::IDX, 6}, {"DOP", &CPU::DOP, &CPU::IMM, 2}, {"ISB", &CPU::ISB, &CPU::IDX, 8}, {"CPX", &CPU::CPX, &CPU::ZRP, 3}, {"SBC", &CPU::SBC, &CPU::ZRP, 3}, {"INC", &CPU::INC, &CPU::ZRP, 5}, {"ISB", &CPU::ISB, &CPU::ZRP, 5}, {"INX", &CPU::INX, &CPU::IMP, 2}, {"SBC", &CPU::SBC, &CPU::IMM, 2}, {"NOP", &CPU::NOP, &CPU::IMM, 2}, {"SBC", &CPU::SBC, &CPU::IMM, 2}, {"CPX", &CPU::CPX, &CPU::ABS, 4}, {"SBC", &CPU::SBC, &CPU::ABS, 4}, {"INC", &CPU::INC, &CPU::ABS, 6}, {"ISB", &CPU::ISB, &CPU::ABS, 6},
        {"BEQ", &CPU::BEQ, &CPU::REL, 2}, {"SBC", &CPU::SBC, &CPU::IDY, 5}, {"KIL", &CPU::KIL, &CPU::IMP, 2}, {"ISB", &CPU::ISB, &CPU::IDY, 8}, {"DOP", &CPU::DOP, &CPU::ZPX, 4}, {"SBC", &CPU::SBC, &CPU::ZPX, 4}, {"INC", &CPU::INC, &CPU::ZPX, 6}, {"ISB", &CPU::ISB, &CPU::ZPX, 6}, {"SED", &CPU::SED, &CPU::IMP, 2}, {"SBC", &CPU::SBC, &CPU::ABY, 4}, {"NOP", &CPU::NOP, &CPU::IMP, 2}, {"ISB", &CPU::ISB, &CPU::ABY, 7}, {"TOP", &CPU::TOP, &CPU::ABX, 4}, {"SBC", &CPU::SBC, &CPU::ABX, 4}, {"INC", &CPU::INC, &CPU::ABX, 7}, {"ISB", &CPU::ISB, &CPU::ABX, 7}
    }};
}
...
void CPU::logInfo() {
#if 0
    std::cout << "PC = 0x" << std::hex << PC << ": " << instruction_rom[opcode].name
        << " A: 0x" << std::hex << (int) A << " X: 0x" << std::hex << (int) X << " Y: 0x" << std::hex
        << (int) Y << std::endl;
#endif
}
 ...
 * MOS 6502 microprocessor is saved; this value is used in the PPU.
 */
void CPU::step() {
    if (cycles == 0) {
        opcode = fetch();
...
uint8_t CPU::read8(uint16_t addr) { return atari->read8(addr, false); }
uint16_t CPU::read16(uint16_t addr) { return atari->read16(addr, false); }
 ...
 ******************************************************************************/
/**
 * Fetch the next byte from RAM pointed to by the CPU's PC register.
 */
...
/**
 * Set the ZERO and SIGN flags of the status register for the given parameter.
 */
void CPU::setZEROSIGN(uint8_t value) {
...
uint8_t CPU::ADC() {
    ...
    (~((uint16_t) A ^ (uint16_t) operand) & ((uint16_t) A ^ sum)) & 0x0080 ?
...
uint8_t CPU::DCP() {
    ...
    PC--;
    if (opcode == 0xCF || opcode == 0xDF || opcode == 0xD8) {
        PC--;
    }
...
uint8_t CPU::ISB() {
    ...
    if (P & DECIMAL) {
        ...
        uint16_t difference = A - operand - (1 - ((P & CARRY) ? 1 : 0));
        -difference & 0x100 ? setBit(CARRY) : clrBit(CARRY);
        (((A ^ operand) & (A ^ difference)) & 128) ? setBit(OVERFLOW) : clrBit(OVERFLOW);
        ...
        ((A ^ difference) & (operand ^ difference) & 0x80) ? setBit(OVERFLOW) : clrBit(OVERFLOW);
        A = difference;
        setZEROSIGN(A);
    }
    return 0;
...
uint8_t CPU::RLA() {
    ...
    PC--;
    if (opcode == 0x2F || opcode == 0x3F || opcode == 0x3B) {
        PC--;
    }
    carry = (P & CARRY) >> 7;
    operand & carry ? setBit(CARRY) : clrBit(CARRY);
...
uint8_t CPU::RRA() {
    ...
    PC--;
    if (opcode == 0x6F || opcode == 0x7F || opcode == 0x7B) {
        PC--;
    }
    carry = (P & CARRY);
    operand & CARRY ? setBit(CARRY) : clrBit(CARRY);
    ...
    if (P & DECIMAL) {
        ...
        (((A ^ ah) & ~(A ^ operand)) & 128) ? setBit(OVERFLOW) : clrBit(OVERFLOW);
        if (ah > 0x9F) {
            ah += 0x60;
        }
        A = ah | (al & 0x0F);
        ...
        sum > 0xFF ? setBit(CARRY) : clrBit(CARRY);
        ((A ^ sum) & (operand ^ sum)) & 0x80 ? setBit(OVERFLOW) : clrBit(OVERFLOW);
        A = sum;
        setZEROSIGN(A);
    }
    return 0;
...
uint8_t CPU::SBC() {
    ...
    if (P & DECIMAL) {
        ...
        (((A ^ operand) & (A ^ sub)) & 128) ? setBit(OVERFLOW) : clrBit(OVERFLOW);
        setZEROSIGN(sub);
        A = (ah << 4) | al;
    } else {
        operand = ~operand;
        ...
        ((sum ^ A) & (sum ^ operand) & 0x0080) ? setBit(OVERFLOW) : clrBit(OVERFLOW);
        A = sum;
        setZEROSIGN(A);
    }
    return 1;
...
uint8_t CPU::SLO() {
    ...
    PC--;
    if (opcode == 0x0F || opcode == 0x1F || opcode == 0x1B) {
        PC--;
    }
    operand & CARRY ? setBit(CARRY) : clrBit(CARRY);
    operand <<= 1;
...
uint8_t CPU::SRE() {
    ...
    PC--;
    if (opcode == 0x4F || opcode == 0x5F || opcode == 0x5B) {
        PC--;
    }
    operand & 0x01 ? setBit(CARRY) : clrBit(CARRY);
    operand >>= 1;
